...
import type { Collection as _Collection, ExternalBlob as _ExternalBlob, NFT as _NFT, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async burnNFT(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createCollection(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createCollection(arg0, arg1, arg2, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCollectionById(arg0: string): Promise<Collection> {
        if (this.processError) {
            try {
                const result = await this.actor.getCollectionById(arg0);
                return from_candid_Collection_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getNFTById(arg0: string): Promise<NFT> {
        if (this.processError) {
            try {
                const result = await this.actor.getNFTById(arg0);
                return from_candid_NFT_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getNFTsByCollection(arg0: string): Promise<Array<NFT>> {
        if (this.processError) {
            try {
    ...
    async mintNFT(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.mintNFT(arg0, arg1, arg2, await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg3), arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCollection(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCollection(arg0, arg1, arg2, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateNFT(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateNFT(arg0, arg1, arg2, await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Collection_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Collection): Promise<Collection> {
...
async function from_candid_NFT_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _NFT): Promise<NFT> {
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        coverImageId: record_opt_to_undefined(await from_candid_opt_n15(_uploadFile, _downloadFile, value.coverImageId)),
        name: value.name,
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Collection>): Promise<Array<Collection>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Collection_n13(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_NFT>): Promise<Array<NFT>> {
    return await Promise.all(value.map(async (x)=>await from_candid_NFT_n18(_uploadFile, _downloadFile, x)));
}
